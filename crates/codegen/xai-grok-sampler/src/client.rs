...
use crate::client_third_party::{
    ...
    deserialize_response_body, flatten_byok_chat_message_content, is_ignorable_response_event,
...
impl SamplingClient {
    ...
    pub async fn chat_completion(
        ...
        // FORK(byok): third-party validators may require plain-string message content
