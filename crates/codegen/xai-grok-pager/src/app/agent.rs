...
impl AgentCommand {
    ...
    pub fn display_name(&self) -> &'static str {
        ...
        match self {
            ...
            Self::SwitchModelCompact => ctx.tr_static("Switching model"),
            Self::CreateWorktree => ctx.tr_static("Creating worktree"),
            Self::RestoreWorktree => ctx.tr_static("Restoring session in worktree"),
            Self::RestoreCode => ctx.tr_static("Restoring code"),
            Self::ForkSession => ctx.tr_static("Forking session"),
            Self::MemoryFlush => ctx.tr_static("Flushing memory"),
            Self::MemoryDream => ctx.tr_static("Consolidating memory"),
        }
    }
